...
\title{Personalized Biopsy Schedules for Men With Low-Risk Prostate Cancer Under Active Surveillance\tnoteref{wordcount}}
\tnotetext[wordcount]{Word count: abstract (headings excluded) 300; Text 2488; Total 2788}
...
%Intro: 510 words
%Cumsum: 510 words
\input{mainmatter/study_cohort}
%Study cohort: 245 words
%Cumsum: 755 words
\input{mainmatter/stat_analysis}
%Stat analysis: 433 words
%Cumsum: 1194 words
\input{mainmatter/result}
%Stat analysis: 537 words
%Cumsum: 1731 words
\input{mainmatter/discussion}
%Stat analysis: 673 words
%Cumsum: 2403 words
