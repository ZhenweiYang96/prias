...
\title[Personalized Schedules for Prostate Cancer Biopsies]
{Personalized Schedules for Prostate Cancer Biopsies}
...
\begin{keywords}
 Active surveillance; Joint models; Personalized medicine; Prostate cancer;.
\end{keywords}
...
\input{mainmatter/joint_model_framework}
\input{mainmatter/pers_sched_framework/pers_biopsy_framework}
\input{mainmatter/choosing_schedule}
\input{mainmatter/pers_schedule_prias}
...
Web Appendix A, C, D and E referenced in Section~\ref{sec : jm_framework},  Section~\ref{sec : pers_schedule_PRIAS},  and  Section~\ref{sec: discussion}, and the derivation of Equation (\ref{eq : expected_time_survprob}) and (\ref{eq : var_time_survprob}) in Web Appendix B, are available in the document supplementary\_material.pdf.\vspace*{-8pt}
