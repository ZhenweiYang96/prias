...
\title[Personalized schedules for biopsies in prostate cancer patientss]
...
\begin{keywords}
Personalized medicine; Prostate cancer; Active surveillance; Joint models.
\end{keywords}
...
Web Appendix A, referenced in Section~\ref{sec : jm_framework}, is available with
