...
\begin{enumerate}
	...
	\hline
	with both $\log_2 \mbox{PSA}$ value and velocity                    & 0.613 [0.582, 0.632] & 0.648 [0.608, 0.685] & 0.593 [0.560, 0.638] \\
	with only $\log_2 \mbox{PSA}$ value                   & 0.595 [0.565, 0.618] & 0.609 [0.568, 0.654] & 0.590 [0.536, 0.628] \\
	\hline
	\end{tabular}	
	\end{center}
	\end{table}
