...
\externaldocument{main_manuscript}
...
\title[Supplementary Materials  for ``Personalized Schedules'']
{Web-based Supplementary Materials for ``Personalized Schedules for Surveillance of Low-Risk Prostate Cancer Patients''}
