...
%$\kappa=5\%$  & 1  & 3.30 &  2  & 5  & 0.33 & 0.66 & 0.65 & 0.91\\
$\kappa=10\%$ & 1  & 2.55 & 2  & 4  & 0.45 & 1.00 & 0.85 & 1.33\\
$\kappa^*(v)$ & 1  & 2.44 & 2  & 3  & 0.46 & 0.89 & 0.86 & 1.26\\
$\kappa^*\{v \mid E(D)\leq 0.75\}$ & 1  & 3.36 & 3  & 5  & 0.32 & 0.61 & 0.63 & 0.88\\
\hline
...
$\kappa=10\%$ & 4  & 4.93 & 5  & 6  & - & - & - & - \\
$\kappa^*(v)$ & 6 & 6.21 & 6  & 7  & - & - & - & -\\
$\kappa^*\{v \mid E(D)\leq 0.75\}$ & 8 & 8.66 & 9  & 9  & - & - & - & -\\
\hline
\end{tabular}
\end{table}