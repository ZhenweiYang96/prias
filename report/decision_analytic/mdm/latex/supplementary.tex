...
\begin{document}
\title{\textbf{Supplementary Materials for ``Personalized Decision Making for Biopsies in Prostate Cancer Active Surveillance Programs''}}
...
\clearpage
\input{supplementary/full_results}
\clearpage
