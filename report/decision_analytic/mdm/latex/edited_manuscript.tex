...
\input{mainmatter-highlighted/abstract}
...
\input{mainmatter-highlighted/introduction}

\section{Methods}
\label{sec:methods}
\input{mainmatter-highlighted/methods_study_pop}
\input{mainmatter-highlighted/methods_jm}
\input{mainmatter-highlighted/methods_pers_decisions}
\input{mainmatter-highlighted/methods_sim_study}

\input{mainmatter-highlighted/results}

\input{mainmatter-highlighted/discussion}

\input{mainmatter-highlighted/acknowledgement}
