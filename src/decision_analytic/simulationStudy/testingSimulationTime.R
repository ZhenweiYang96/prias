...
sigma_psa = mvJoint_dre_psa_dre_value$statistics$postMeans$sigma2
D = mvJoint_dre_psa_dre_value$statistics$postMeans$D
...
#Ctimes<-runif(nSubTraining, 0, 25)
