...
fitJointModelOnNewData = function(seed, nSub, nSubTraining, nSubTest, 
  ...
  print("fitting mvglmer to training ds without trimming off longitudinal obs")
  mvglmer_dre_psa_simDs_notrimming = mvglmer(list(high_dre~I(Age - 70) +  I((Age - 70)^2) + visitTimeYears  +
                                         (visitTimeYears|P_ID),
  ...
  mvglmer_dre_psa_simDs_replaced = mvglmer_dre_psa_simDs
  mvglmer_dre_psa_simDs_replaced$mcmc = mvglmer_dre_psa_simDs_notrimming$mcmc
  mvglmer_dre_psa_simDs_replaced$postMeans = mvglmer_dre_psa_simDs_notrimming$postMeans
  ...
  mvJoint_dre_psa_simDs = mvJointModelBayes(mvglmer_dre_psa_simDs_replaced, survModel_simDs,
  ...
  out = list("trainingData"=list(trainingDs=trainingDs, trainingDs.id=trainingDs.id),
             ...
             "survModel_simDs"=survModel_simDs, "mvglmer_dre_psa_simDs_notrimming"=mvglmer_dre_psa_simDs_notrimming,
