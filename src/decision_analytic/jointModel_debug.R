jointModel_debug <- function (lmeObject, survObject, timeVar, parameterization = c("value", "slope", "both"), 
  ...
  #weibullPHGH.fit_debug(x, y, id, initial.values, scaleWB, parameterization, derivForm, con)
...
environment(jointModel_debug) <- asNamespace('JM')
