survfitJM_new <- function (object, newdata, survTimes = NULL, idVar = "id", 
...
environment(survfitJM_new) = asNamespace("JMbayes")

set.seed(2019)
apply(getExpectedFutureOutcomes(mvJoint_psa_time_scaled, 
                                prias_long_final[1:10,],0, 
                                Inf, 1:5, M = 500, psaDist = "Tdist")$predicted_surv_prob, 1, mean) 
set.seed(2019)
survfitJM_new(mvJoint_psa_time_scaled, prias_long_final[1:10,],idVar = "P_ID", survTimes = 1:5, last.time = 0, M=500, seed = 2019)[[1]][[1]][,"Mean"]
