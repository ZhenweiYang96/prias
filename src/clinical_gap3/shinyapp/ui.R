                    ...
                    mainPanel(
                      tabsetPanel(type = "tabs",
                                  ...
                                  tabPanel("Biopsy recommendation", 
                                           ...
                                           tags$br(),
                                           tags$span('More information on delay, and reclassification are in the "Documentation" tab.', class='label label-default'),
                                  ...
                                  tabPanel("Documentation", 
                                           ...
                                           tags$span("A compulsory biopsy was scheduled at year ten of follow-up in all schedules for meaningful comparison of their expected delays in detection of Gleason reclassification.", class='lead'),
                                           tags$hr(),
