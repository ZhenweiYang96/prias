                    ...
                    mainPanel(
                      tabsetPanel(type = "tabs",
                                  ...
                                  tabPanel("Biopsy recommendation", 
                                           ...
                                           tags$br(),
                                           tags$span('More information on the definition of the delay can be found in Section 6 of the "Documentation" tab.', class='label label-default'),
