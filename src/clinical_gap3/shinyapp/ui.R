                    ...
                    mainPanel(
                      tabsetPanel(type = "tabs",
                                  ...
                                  tabPanel("Documentation", 
                                           ...
                                           tags$span("A compulsory biopsy was scheduled at year six of follow-up in all schedules for meaningful comparison of their expected delays in detection of Gleason Upgrading.", class='lead'),
                                           tags$hr(),
                                           tags$h2(tags$span("6. Expected time delay in detecting Gleason Upgrading", class='label label-success')),
