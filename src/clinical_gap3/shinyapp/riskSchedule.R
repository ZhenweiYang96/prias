compareSchedules = function(patient_data, cur_visit_time, latest_survival_time,
  ...
  visit_schedule = PSA_CHECK_UP_TIME[PSA_CHECK_UP_TIME >= cur_visit_time & PSA_CHECK_UP_TIME<=MAX_FOLLOW_UP]
  ...
  annual_schedule = seq(cur_visit_time, MAX_FOLLOW_UP, by=1)
  ...
  biennial_schedule = seq(cur_visit_time, MAX_FOLLOW_UP, by=2)
