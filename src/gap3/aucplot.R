...
auc_onlypsa_file_names = list.files("Rdata/gap3/auc_only_psa/", full.names = T)
prederr_onlypsa_file_names = list.files("Rdata/gap3/prederr_only_psa/", full.names = T)
...
pdf("Rdata/gap3/plots.pdf", width = 12, height = 7)
