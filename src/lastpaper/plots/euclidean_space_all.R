...
tree_schedules = personalizedSchedule.mvJMbayes(object=mvJoint_dre_psa_2knots_quad_age,
                                           newdata = pat_data, idVar = "P_ID", last_test_time = 1.5,
                                           gap = 1, fixed_grid_visits = seq(cur_visit_time, to = MAX_FOLLOW_UP, by = 0.5), 
                                           seed = 2019, risk_based_schedules_only = F)


risk_schedules = personalizedSchedule.mvJMbayes(object=mvJoint_dre_psa_2knots_quad_age,
                                           newdata = pat_data, idVar = "P_ID", last_test_time = 1.5,
                                           gap = 1, fixed_grid_visits = seq(cur_visit_time, to = MAX_FOLLOW_UP, by = 0.5), 
                                           seed = 2019)
