...
fitted_velocities = X_Z %*% mvJoint_dre_psa_2knots_quad_age$statistics$postMeans$betas2[-c(1:3)] +
  apply(X_Z * mvJoint_dre_psa_2knots_quad_age$statistics$postMeans$b[rep(1:7813, psacount_per_patient),-c(1:3)], MARGIN = 1, sum)
