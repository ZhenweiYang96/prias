...
generateTDistError = function(n){
  sigma_psa = mvJoint_dre_psa_2knots_quad_age_light$statistics$postMeans$sigma2
...
generateTruePSAProfile = function(age, year_visit, randomEff_psa){
  betas_psa = mvJoint_dre_psa_2knots_quad_age_light$statistics$postMeans$betas2
...
generateTruePSASlope = function(year_visit, randomEff_psa_slope){
  betas_psa_time = mvJoint_dre_psa_2knots_quad_age_light$statistics$postMeans$betas2[IND_FIXED_PSA_SLOPE]
...
generateTrueDRELogOdds = function(age, year_visit, randomEff_dre){
  betas_dre = mvJoint_dre_psa_2knots_quad_age_light$statistics$postMeans$betas1
  df = data.frame(age, year_visit)
...
generateSimulationData = function(nSub, psaErrorDist = "t3", bNames){
  ...
  hazardFunc = function (year_visit, patientId) {
    alphas = mvJoint_dre_psa_2knots_quad_age_light$statistics$postMeans$alphas
  ...
  D = mvJoint_dre_psa_2knots_quad_age_light$statistics$postMeans$D
  ...
  gammas = mvJoint_dre_psa_2knots_quad_age_light$statistics$postMeans$gammas
...
fitJointModelOnNewData = function(simDs, simDs.id, timesPerSubject, nSubTraining, nSubTest, 
